...
Current project version: `0.3.19`
...
- the WebSocket uploader now sends one `32 KB` binary chunk at a time and waits up to `5s` for a firmware ACK before sending the next chunk
